...
- After editing skill definitions, run policy lint and quick validation before committing:
  - preferred all-skills check: `python3 /path/to/codex/skills/validate_skills.py`
  - targeted policy check: `python3 /path/to/codex/skills/lint_skill_policy.py <skill_directory>`
  - targeted frontmatter check: `python3 /path/to/codex/skills/.system/skill-creator/scripts/quick_validate.py <skill_directory>`
