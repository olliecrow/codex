...
## Skills
- Current skills: `battletest`, `cleanup`, `commit`, `dangercheck`, `decisions`, `execute`, `familiarize`, `gitsummary`, `gitmerge`, `gitreview`, `investigate`, `plan`, `setup`, `summarize`, `techdebt`, `verify`.
