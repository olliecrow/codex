---
name: prime
description: Prime any conversation at session start by establishing cross-project operating principles, autonomy defaults, verification posture, and recurring execution loops. Use when the user asks to prime the session or wants proactive/autonomous behavior with minimal unnecessary questions, frequent docs updates, frequent checkpoint commits, and regular cleanup.
---
...
Set a clear session operating contract, activate recurring loops (`organise-docs`, `git-commit`, `cleanup`, verification), and keep enforcing the contract for the rest of the conversation.
...
### 2) Establish session operating contract
...
### 3) Define the active execution loop
...
### 4) Activate recurring hygiene loops
...
### 6) Enforce throughout the session
